...
## Limitations
While performances of strategys are in a simple manner evaluated, several aspects are neccessary for a complete framework.
...
This is why I decided to go the data analytics way and put the qoute from Marcos López de Prado on the top. 
